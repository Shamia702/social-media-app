...
//       return title.includes(query) || body.includes(query) || authorName.includes(query);
//     });
...
function renderPost(post) {
  ...
  // ✅ Link both avatar and author name to profile.html?user=username
  return `
    <div class="col-12 col-md-6 col-lg-4 d-flex">
      <div class="card shadow-sm border-0 rounded-4 flex-fill d-flex flex-column">
        <div class="card-body d-flex flex-column">
          ...
          <div class="d-flex align-items-center mb-3">
            <a href="profile.html?user=${authorName}" class="text-decoration-none d-flex align-items-center">
              <img src="${avatar}" alt="${authorName}" class="rounded-circle me-3" width="50" height="50" />
              <h5 class="mb-0 text-primary">${authorName}</h5>
            </a>
          </div>
